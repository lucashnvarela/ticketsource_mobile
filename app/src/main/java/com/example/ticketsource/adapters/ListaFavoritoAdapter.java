...
import com.example.ticketsource.views.MenuMainActivity;

public class ListaFavoritoAdapter extends BaseAdapter {

	private Context context;
	private LayoutInflater inflater;
	private ArrayList<Evento> eventos;

	public ListaFavoritoAdapter(Context context, ArrayList<Evento> eventos) {
